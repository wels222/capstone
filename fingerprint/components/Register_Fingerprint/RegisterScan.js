export function RegisterScan(containerId, status, textLog) {
...
function activateAnimation(container) {
    ...
    switch (status.toLowerCase()) {
        ...
        case 'disconnected':
    container.style.backgroundImage = "url('./icon_svg/fingerprint_dummy.svg')";
    container.style.backgroundRepeat = 'no-repeat';
    container.style.backgroundSize = 'contain';
    container.style.backgroundPosition = 'center';
    container.style.position = 'relative'; // needed for pseudo-element
    ...
    if (!container.querySelector('.overlay')) {
        ...
        overlay.style.cssText = `
            ...
            background-color: rgba(255, 255, 255, 0.9); /* white 50% */
